# Generated by Django 5.0.6 on 2024-08-26 19:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Price',
            fields=[
                ('Combo_ID', models.CharField(editable=False, max_length=200, primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('Befor_Tax_price', models.DecimalField(decimal_places=3, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_info', to='website.price')),
            ],
            options={
